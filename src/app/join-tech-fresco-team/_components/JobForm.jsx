              ...
              <>
                ...
                <Form>
                  ...
                  <div>
                    <Field
                      ...
                      className={
                        touched.portfolio && errors.portfolio ? "invalid" : ""
                      }
                    />
                    <ErrorMessage
                      name="portfolio"
                  ...
                  <div>
                    <Field
                      ...
                      className={
                        touched.expertise && errors.expertise ? "invalid" : ""
                      }
                    />
                    <ErrorMessage
                      name="expertise"
                  ...
                  <div>
                    <Field
                      ...
                      className={
                        touched.experience && errors.experience ? "invalid" : ""
                      }
                    />
                    <ErrorMessage
                      name="experience"
                  ...
                  <div className="full">
                    <Field
                      ...
                      className={
                        touched.motivation && errors.motivation ? "invalid" : ""
                      }
                    />
                    <ErrorMessage
                      name="motivation"
                  ...
                  <div className="checkbox">
                    <Field
                      ...
                      className={
                        touched.policyCheckboxJob && errors.policyCheckboxJob
                          ? "invalid"
                          : ""
                      }
                    ...
                    <label for="policyCheckboxJob">
                      <CheckboxIcon />
                      <span>
                        I agree to the processing of my personal data by Tech
                        Fresco in accordance with the Privacy Policy for the
                        purpose of handling my application.
                      </span>
                    </label>
                  </div>
                ...
                {status && status.success && (
                  <div className="success-message">
                    <img src="/images/successBlack.svg" alt="Success" />
                    <span>
